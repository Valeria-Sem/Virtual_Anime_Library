...
namespace Virtual_Anime_Library.AnimeDataSetTableAdapters {
...
SELECT ID, Login, Password FROM password WHERE (ID = @ID)";
        ...
        public virtual int Fill(AnimeDataSet.passwordDataTable dataTable) {
        ...
        public virtual AnimeDataSet.passwordDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AnimeDataSet.passwordDataTable dataTable = new AnimeDataSet.passwordDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AnimeDataSet.passwordDataTable dataTable) {
